...
let clock = new Vue ({
  ...
  methods: {
    ...
    newGame: function () {
      this.reset ();
      newGame (); // in chess_p30_site
    },
    fixPGN: function () {
      white (this.player_white);
      black (this.player_black);
    },
  },
  filters: {
  ...
  // watch: {
  //   player_white: (newName, oldName) => {
  //     white (newName);
  //     game.header ('White', newName);
  //     updateStatus ();
  //   },
  //   player_black: (newName, oldName) => {
  //     black (newName);
  //     game.header ('Black', newName);
  //     updateStatus ();
  //   },
  // },
});
